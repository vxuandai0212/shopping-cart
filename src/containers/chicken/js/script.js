...
let Bird = function () {
   ...
   this.behaviourInterval = undefined
...
Bird.prototype.lookAway = function (fastMove) {
   ...
   var ease = fastMove ? Power4.easeOut : Power4.easeInOut;
...
Bird.prototype.stare = function () {
   ...
   TweenMax.to(this.shyAngles, 2, { v: -.5, h: th, ease: Power4.easeInOut });
   TweenMax.to(this.color, 2, { r: col.r, g: col.g, b: col.b, ease: Power4.easeInOut });
   TweenMax.to(this.beak.scale, 2, { z: .8, x: 1.5, ease: Power4.easeInOut });
